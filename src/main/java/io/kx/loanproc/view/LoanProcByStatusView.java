...
public class LoanProcByStatusView extends AbstractLoanProcByStatusView {
  ...
  @Override
  public UpdateEffect<LoanProcByStatusModel.LoanProcViewState> onSubmitted(
  ...
  @Override
  public UpdateEffect<LoanProcByStatusModel.LoanProcViewState> onApproved(
  ...
  @Override
  public UpdateEffect<LoanProcByStatusModel.LoanProcViewState> onDeclined(
  ...
  @Override
  public UpdateEffect<LoanProcByStatusModel.LoanProcViewState> ignoreOtherEvents(
